...
class EA2FrancaUtils
{
    ...
    def EAElementContainer getBaseElement(EAElementContainer element)
    {
        ...
        if(null != baseClass && !baseClass.francaDataType.equals(element.francaDataType))
        {
    ...
    def EAElementContainer getOppositeFrancaInterfaceElement(EAElementContainer element)
    {
        ...
        val oppositeFrancaInterfaceElements = element.getConnectors(EAConnectorContainer.ASSOCIATION).filter [ connector |
            ...
            val filter = oppositeElement.type.equals(EAConstants.TYPE_INTERFACE) && (elementName.equals(
                oppositeElementName + EAFrancaConstants.CLIENT_INTERFACE_NAME_SUFFIX) ||
    ...
    def EAElementContainer getArrayTypeElement(EAElementContainer element)
    {
        ...
        val arrayOfAssociations = element.getConnectors(EAConnectorContainer.ASSOCIATION).filter [ connector |
