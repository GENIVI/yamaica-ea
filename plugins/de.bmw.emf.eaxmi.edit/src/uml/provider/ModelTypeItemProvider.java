...
/**
 * This is the item provider adapter for a {@link uml.ModelType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        IItemPropertySource
{
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 UmlPackage.Literals.MODEL_TYPE__NAME,
                 true,
                 false,
                 false,
    ...
    protected void addTypePropertyDescriptor(Object object)
    {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ModelType_type_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ModelType_type_feature", "_UI_ModelType_type"),
                 UmlPackage.Literals.MODEL_TYPE__TYPE,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addVisibilityPropertyDescriptor(Object object)
    {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ModelType_visibility_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ModelType_visibility_feature", "_UI_ModelType_type"),
                 UmlPackage.Literals.MODEL_TYPE__VISIBILITY,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
    {
        if (childrenFeatures == null)
        {
            ...
            childrenFeatures.add(UmlPackage.Literals.MODEL_TYPE__PACKAGED_ELEMENT);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
    {
        ...
        newChildDescriptors.add
            (createChildParameter
                (UmlPackage.Literals.MODEL_TYPE__PACKAGED_ELEMENT,
