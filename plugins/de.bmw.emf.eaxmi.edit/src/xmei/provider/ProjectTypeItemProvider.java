...
/**
 * This is the item provider adapter for a {@link xmei.ProjectType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        IItemPropertySource
{
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 XmeiPackage.Literals.PROJECT_TYPE__AUTHOR,
                 true,
                 false,
                 false,
    ...
    protected void addCreatedPropertyDescriptor(Object object)
    {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ProjectType_created_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ProjectType_created_feature", "_UI_ProjectType_type"),
                 XmeiPackage.Literals.PROJECT_TYPE__CREATED,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addModifiedPropertyDescriptor(Object object)
    {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ProjectType_modified_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ProjectType_modified_feature", "_UI_ProjectType_type"),
                 XmeiPackage.Literals.PROJECT_TYPE__MODIFIED,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addPhasePropertyDescriptor(Object object)
    {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ProjectType_phase_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ProjectType_phase_feature", "_UI_ProjectType_type"),
                 XmeiPackage.Literals.PROJECT_TYPE__PHASE,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addVersionPropertyDescriptor(Object object)
    {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ProjectType_version_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ProjectType_version_feature", "_UI_ProjectType_type"),
                 XmeiPackage.Literals.PROJECT_TYPE__VERSION,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    {
        String label = ((ProjectType)object).getAuthor();
