...
/**
 * This is the item provider adapter for a {@link xmei.Documentation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        IItemPropertySource
{
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Documentation_exporter_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Documentation_exporter_feature", "_UI_Documentation_type"),
                 XmeiPackage.Literals.DOCUMENTATION__EXPORTER,
                 true,
                 false,
                 false,
    ...
    protected void addExporterVersionPropertyDescriptor(Object object)
    {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Documentation_exporterVersion_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Documentation_exporterVersion_feature", "_UI_Documentation_type"),
                 XmeiPackage.Literals.DOCUMENTATION__EXPORTER_VERSION,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    {
        String label = ((Documentation)object).getExporter();
