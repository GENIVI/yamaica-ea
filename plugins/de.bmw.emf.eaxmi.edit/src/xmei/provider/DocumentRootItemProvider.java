...
/**
 * This is the item provider adapter for a {@link xmei.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        IItemPropertySource
{
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 XmeiPackage.Literals.DOCUMENT_ROOT__ID,
                 true,
                 false,
                 false,
    ...
    protected void addIdrefPropertyDescriptor(Object object)
    {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DocumentRoot_idref_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_DocumentRoot_idref_feature", "_UI_DocumentRoot_type"),
                 XmeiPackage.Literals.DOCUMENT_ROOT__IDREF,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 XmeiPackage.Literals.DOCUMENT_ROOT__TYPE,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 XmeiPackage.Literals.DOCUMENT_ROOT__VERSION,
                 true,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
    {
        if (childrenFeatures == null)
        {
            ...
            childrenFeatures.add(XmeiPackage.Literals.DOCUMENT_ROOT__XMI);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
    {
        ...
        newChildDescriptors.add
            (createChildParameter
                (XmeiPackage.Literals.DOCUMENT_ROOT__XMI,
                 XmeiFactory.eINSTANCE.createXMIType()));
    }
