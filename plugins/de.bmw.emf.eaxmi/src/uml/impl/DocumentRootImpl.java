 ...
 *   <li>{@link uml.impl.DocumentRootImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot
{
    ...
    {
        return (ModelType)getMixed().get(UmlPackage.Literals.DOCUMENT_ROOT__MODEL, true);
    }
    ...
    {
        return ((FeatureMap.Internal)getMixed()).basicAdd(UmlPackage.Literals.DOCUMENT_ROOT__MODEL, newModel, msgs);
    }
    ...
    {
        ((FeatureMap.Internal)getMixed()).set(UmlPackage.Literals.DOCUMENT_ROOT__MODEL, newModel);
    }
